    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: '0 0.8rem', borderTop: '1px solid var(--border)', paddingTop: '1rem', marginTop: '1rem' }}>
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '0.7rem', padding: '0.65rem 0.9rem', borderRadius: 10, color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '0.3rem', textDecoration: 'none', transition: 'all 0.2s', border: '1px solid var(--border)' }}
